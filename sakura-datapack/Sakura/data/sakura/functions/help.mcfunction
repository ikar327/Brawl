# Lista komend data packa
tellraw @s [{"text":"\n\u2740 Sakura \u2740","color":"light_purple","bold":true}]
tellraw @s [{"text":"/function sakura:tree","color":"aqua"},{"text":" - losowe drzewo sakura pod toba","color":"gray"}]
tellraw @s [{"text":"/function sakura:grove","color":"aqua"},{"text":" - caly gaj sakury wokol ciebie","color":"gray"}]
